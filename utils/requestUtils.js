 ...
 *
 * @param {http.incomingMessage} request request handle
 ...
 *
 * @param {http.incomingMessage} request req handle
 * @returns {boolean} accepts JSON
 */
 ...
 *
 * @param {http.incomingMessage} request req handle
 * @returns {boolean} content tupe JSON
 */
