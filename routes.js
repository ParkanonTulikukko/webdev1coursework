 ...
 * @param {string} prefix text before the id part
 ...
 * 
 * @param {*} request - request that determines what actions should be taken
 * @param {*} response - response that is sent as a response to the client
 */
